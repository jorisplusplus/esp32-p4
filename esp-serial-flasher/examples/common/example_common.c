...
extern const uint8_t  ESP32_C6_network_adapter_bin[];
extern const uint32_t ESP32_C6_network_adapter_bin_size;
extern const uint8_t  ESP32_C6_network_adapter_bin_md5[];
...
void get_example_binaries(target_chip_t target, example_binaries_t *bins)
{
    if (target == ESP32C6_CHIP) {
        ...
        bins->app.data  = ESP32_C6_network_adapter_bin;
        bins->app.size  = ESP32_C6_network_adapter_bin_size;
        bins->app.md5 = ESP32_C6_network_adapter_bin_md5;
